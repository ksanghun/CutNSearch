...
int CClassView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	if (!m_listCtrl.Create(dwViewStyle, rectDummy, this, 2))
	{
...
void CClassView::FillClassView()
{
	...
	//m_listCtrl.InsertColumn(0, _T("Cut Img."), LVCFMT_CENTER, 100);
	//m_listCtrl.InsertColumn(1, _T("Date"), LVCFMT_CENTER, 100);


//	IplImage *gray = cvLoadImage("C:\temp\test.bmp");

	//CImageList imagelist;
	//imagelist.Create(64, 64, ILC_COLOR24, 0, 3);
	//HANDLE hBitMap = ::LoadImage(0, L"C:\temp\test.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
	//CBitmap bitmap;
	//bitmap.Attach((HBITMAP)hBitMap);

	//imagelist.Add(&bitmap, RGB(0, 0, 0));
	m_listCtrl.SetImageList(&m_ClassViewImages, LVSIL_SMALL);
	...
	column.cx = 50;
	column.pszText = (LPWSTR)&L"Cut";
	column.iImage = 0;

	m_listCtrl.InsertColumn(0, &column);
	m_listCtrl.InsertColumn(1, _T("Date"), LVCFMT_LEFT, 100);
...
void CClassView::OnContextMenu(CWnd* pWnd, CPoint point)
{
	...
	/*
	CLogListCtrl* pWndTree = (CLogListCtrl*)&m_listCtrl;
...
//	m_wndToolBar.SetWindowPos(NULL, rectClient.left, rectClient.top, rectClient.Width(), cyTlb, SWP_NOACTIVATE | SWP_NOZORDER);
	m_listCtrl.SetWindowPos(NULL, rectClient.left + 1, rectClient.top + 1, rectClient.Width() - 2, rectClient.Height() - 2, SWP_NOACTIVATE | SWP_NOZORDER);
}
...
void CClassView::AddLogList(CBitmap* bmp, CString strDate)
{
	BITMAP bmpObj;
	...
	int index = m_listCtrl.InsertItem(m_listAddCnt, _T(""), m_listAddCnt);
	m_listCtrl.SetItemText(m_listAddCnt, 1, strDate);
...
//	m_ClassViewImages.Create(16, bmpObj.bmHeight, nFlags, 0, 0);
	m_ClassViewImages.Create(32, 32, nFlags, 0, 0);
//	m_ClassViewImages.Add(&bmp, RGB(255, 0, 0));
	m_listCtrl.SetImageList(&m_ClassViewImages, TVSIL_NORMAL);
